    ...
    <div v-else-if="lab" class="space-y-6">
      ...
      <div class="bg-yellow-50 border border-yellow-200 rounded-2xl p-4">
        <div class="flex items-center">
          <div class="icon icon-thermometer text-yellow-600 mr-2"></div>
          <div>
            <h4 class="text-sm font-medium text-yellow-800">Development Notice</h4>
            <p class="text-sm text-yellow-700 mt-1">
              The laboratory detail page is under development. Currently showing basic information. 
              Full features include: environmental monitoring, equipment management, booking schedule, etc.
            </p>
          </div>
        </div>
      </div>
